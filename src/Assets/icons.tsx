...
export const Icon = function(props:IconProps){

  return(
    <div className={props.className ? props.className + ' iconContainer' : 'iconContainer'} onClick={ props.onClick } >
      {icons[props.name]}
    </div>
  )
